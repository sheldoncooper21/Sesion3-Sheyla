...
class testCuenta {
	...
	void testRetirarSinSaldo() {
		boolean resultado1 = cuenta12345.retirar(200);
		assertTrue(resultado1); // Debe devolver false ya que no hay saldo suficiente(50€)

		boolean resultado2 = cuenta67890.retirar(350);
		assertTrue(resultado2); // Debe devolver false ya que no hay saldo suficiente (0€)
	}
	...
	void testRetirarExcedeLimiteDescubierto() {
		...
		boolean resultado2 = cuenta67890.retirar(600);
		assertFalse(resultado);
